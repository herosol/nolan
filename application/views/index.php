            ...
            <div class="contain">
                <div class="flex_row">
                    ...
                    <div class="col col2" data-aos="fade-up" data-aos-duration="1000">
                        <div class="image"><img class="lazy" data-original="<?= !empty($content['image3']) ? get_site_image_src("images", $content['image3']) : base_url().'assets/images/banner_img.jpg' ?>" src="" alt=""></div>
                    </div>
                </div>
            </div>
            <div class="fig"><img class="lazy" data-original="<?= !empty($content['image2']) ? get_site_image_src("images", $content['image2']) : base_url().'assets/images/13.png' ?>" src="" alt=""></div>
        </section>
        <!-- banner -->
            ...
            <div class="contain">
                <div class="flex_row">
                    <div class="col col1" data-aos="fade-left" data-aos-duration="1000">
                        <div class="image"><img class="lazy" data-original="<?= !empty($content['image4']) ? get_site_image_src("images", $content['image4']) : base_url().'assets/images/intro_01.jpg' ?>" src="" alt=""></div>
                    </div>
            ...
            <div class="contain text-center" data-aos="fade-down" data-aos-duration="1000">
                ...
                <ul class="gallery_lst flex">
                    <?php foreach($gallery as $image): ?>
                        <li class="col"><a href="<?=get_site_image_src("gallery", $image->image)?>" data-fancybox="gallery"><img class="lazy" data-original="<?=get_site_image_src("gallery", $image->image)?>" src="" alt=""></a></li>
                    <?php endforeach; ?>
                </ul>
        ...
        <section id="merch">
            <div class="contain">
                <div class="flex_row">
                    ...
                    <div class="col col2" data-aos="fade-right" data-aos-duration="1000">
                        <div class="image"><img class="lazy" data-original="<?= !empty($content['image5']) ? get_site_image_src("images", $content['image5']) : base_url().'assets/images/shirt.png' ?>" src="" alt=""></div>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="contain text-center" data-aos="fade-down" data-aos-duration="1000">
                ...
                <div class="flex_row full_height">
                    <?php foreach($team as $member): ?>
                        <div class="col">
                            <div class="inner">
                                <div class="ico"><img class="lazy" data-original="<?=get_site_image_src("team", $member->image, 'thumb_')?>" src="" alt=""></div>
                                <div class="txt">
                                    <h4><?=$member->name?></h4>
                                    <p><?=$member->tagline?></p>
                                </div>
