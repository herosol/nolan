<?php if ($this->uri->segment(3) == 'manage'): ?>
    <?= showMsg(); ?>
    <?= getBredcrum(ADMIN, array('#' => 'Add/Update Phases')); ?>
    <div class="row margin-bottom-10">
        <div class="col-md-6">
            <h2 class="no-margin"><i class="entypo-list"></i> Add/Update <strong>Phases</strong></h2>
        </div>
    ...
    <div>
        ...
        <div class="row col-md-12">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        <label class="control-label" for="detail">  Phase Detail</label>
...
<?php else: ?>
    <?= showMsg(); ?>
    <?= getBredcrum(ADMIN, array('#' => 'Manage Phases')); ?>
    <div class="row margin-bottom-10">
        <div class="col-md-6">
            <h2 class="no-margin"><i class="entypo-list"></i> Manage <strong>Phases</strong></h2>
        </div>
        <div class="col-md-6 text-right">
