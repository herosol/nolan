<?php if ($this->uri->segment(3) == 'manage'): ?>
	...
	<?= getBredcrum(ADMIN, array('#' => 'Add/Update Team Members')); ?>
	<div class="row margin-bottom-10">
		<div class="col-md-6">
			<h2 class="no-margin"><i class="entypo-list"></i> Add/Update <strong>Team Member</strong></h2>
		</div>
			...
			<form action="" name="frmLocation" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
				<div class="col-md-12">
					<div class="form-group">
								...
								<div class="panel-body">
									<div class="fileinput fileinput-new" data-provides="fileinput"><input type="hidden"><input type="hidden">
										<div class="fileinput-new thumbnail" style="max-width: 310px; height: 110px;" data-trigger="fileinput">
											<img src="<?= !empty($row->image) ? getImageSrc(SITE_IMAGES . "/team/thumb_", $row->image) : 'http://placehold.it/1500x1000' ?>" alt="--">
										</div>
						...
						<div class="col-md-6">
							<label for="" class="control-label">Name<span class="symbol required">*</span></label>
...
<?php else: ?>
	<?= showMsg(); ?>
	<?= getBredcrum(ADMIN, array('#' => 'Manage Team Members')); ?>
	<div class="row margin-bottom-10">
		<div class="col-md-6">
			<h2 class="no-margin"><i class="entypo-list"></i> Manage <strong>Team Members</strong></h2>
		</div>
		<div class="col-md-6 text-right">
			...
			<?php if (count($rows) > 0): $count = 0; ?>
				<?php foreach ($rows as $row): 
					...
					<tr class="odd gradeX">
						...
						<td><img src="<?=  getImageSrc(UPLOAD_PATH . "/team/thumb_", $row->image) ?>" height="50" alt="--"></td>
						<td><?=  $row->name ?></td>
						<td><?=  $row->tagline ?></td>
